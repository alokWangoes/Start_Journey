  ...
  return (
    <>
            ...
            <div key={item.id} className="inline-grid flex-col">
              <div className="">
                <img
                  src="/image-1.svg"
                  alt=""
                  style={{ borderRadius: "25px 25px 0px 0px", width: "100%" }}
                />
              </div>
              <div
                className=""
                style={{
                  ...
                  backgroundColor: "rgba(234,193,205,0.6)",
              ...
              >
                <div className="w-30 text-center">
                  ...
                  <p className="" style={{ color: "#52459B" }}>
                    {item.description}
                  </p>
                </div>
              </div>
      ...
      {/* <div className="grid gap-10 w-2/3 m-auto mt-32 pb-20">
        <div
          className="flex flex-row items-center border rounded-[165px]"
          style={{
            backgroundColor: "rgba(234, 192, 205, 1)",
            border: "10px solid rgba(213, 152, 238, 1)",
        ...
        >
          <div className="w-1/2">
            <h4 className="mb-8 text-3xl font-bold text-[#3D318A] ">
            ...
            <div className="flex justify-center">
              <button
                className="relative font rounded-md w-36 h-10 overflow-hidden flex flex-row  box-border items-center justify-center  text-left  text-white font-aclonica"
                style={{
                  backgroundImage:
                    "linear-gradient(to top, rgba(137,129,184,60%), rgba(137,129,184,100%))",
                }}
              >
                Subscribe
              </button>
        ...
        >
          <div className="w-auto h-72">
            <h4 className="mb-8 pt-10 px-5 text-3xl font-bold text-[#3D318A] ">
              Lorem ipsum dolor sit amet consectetur.
            </h4>
            <p className="mb-8 px-5  text-[#43397C]">
              Lorem ipsum dolor sit amet consectetur. Ante leo odio luctus urna
              est risus euismod. Semper quis porttitor lorem malesuada nisl a
              non imperdiet. Fames aenean cursus at netus.
            </p>
          ...
          <div className="w-auto ">
            <Image alt="subscribe-image" src="/img-2.svg" width={800} height={500}></Image>
          </div>
        </div>
      </div>
    </>
